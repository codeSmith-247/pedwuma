    ...
    return (
        <nav className="border p-3 py-2 flex justify-between items-center">
            ...
            <div className={`nav-links fixed text-white md:text-neutral-900 md:static top-0 h-screen md:h-max backdrop-blur-3xl bg-black bg-opacity-95 md:bg-opacity-0 z-20 min-w-[300px] p-5 md:p-0 items-center md:flex transform scale-95 rounded-md ${menuState}`}>
                ...
                <Link class={`block font-bold px-5 py-2 my-2 mx-1 md:my-0  rounded-md border-2 border-green-400 hover:border-green-300 btn overflow-hidden text-center bg-green-400 before:bg-green-300`} to="signup"><span>Sign Up</span></Link>
            </div>

            <div className="menu-btn border-2 rounded-md text-2xl px-1 md:hidden" onClick={() => setMenuState("right-0")}>
